...
to go
  ask turtle 0 [ set heat nivelAgua ]
  ask turtle 0 [ cauceRio ]
  ask turtle 1 [ set heat nivelAgua ]
  ask turtle 1 [ cauceRio ]
  ask turtle 2 [ set heat nivelAgua ]
  ask turtle 2 [ cauceRio ]
  ask turtle 3 [ set heat nivelAgua ]
  ask turtle 3 [ cauceRio ]
  ask turtle 4 [ set heat nivelAgua ]
  ask turtle 4 [ cauceRio ]
  contador-tiempo
  if Llueve? [ ask turtles [ branchs ] ]
  diffuse heat diffusionRio
  recolor-patches
  tick
end
...
to contador-tiempo
  set #-minutos ticks
  set #-horas floor (ticks / 60)
end

to cauceRio ; inicia el moviemiento del rio
  set heading 90
  fd velocidadDispercionRio
end

to branchs ; inicia el moviemiento del rio
  ask turtle 1 [
...
to crear-ciudad
  ...
  ask patches with [pcolor = black] [
    if pycor <= ciudad-top  and pycor > ciudad-bot [ ;; tierra
      set pcolor red + 8
      sprout 1 [
      set color red + 8
      stamp
  ...
  ask patches with [pcolor = red + 8] [
    if count neighbors with [pcolor = red + 8] = 8 and not any? houses in-radius 15 [
      sprout-houses 1 [
        set shape one-of ["house"]
        set size 4
        stamp
      ]
    ]
...
Polygon -10899396 true false 168 85 166 64 193 51 192 17 150 2 108 18 108 52 131 65 128 87
Polygon -10899396 true false 215 204 240 233 246 254 228 266 215 252 193 210
Polygon -7500403 true false 181 75 121 75 91 101 76 135 80 225 125 261 172 261 219 224 226 135 212 99
...
1.0
    org.nlogo.sdm.gui.AggregateDrawing 5
        org.nlogo.sdm.gui.ConverterFigure "attributes" "attributes" 1 "FillColor" "Color" 130 188 183 318 178 50 50
            org.nlogo.sdm.gui.WrappedConverter "velocidadDispercionRio" "tiempo"
        org.nlogo.sdm.gui.StockFigure "attributes" "attributes" 1 "FillColor" "Color" 225 225 182 517 93 60 40
            org.nlogo.sdm.gui.WrappedStock "tiempo2" "0" 0
        org.nlogo.sdm.gui.ReservoirFigure "attributes" "attributes" 1 "FillColor" "Color" 192 192 192 375 95 30 30
        org.nlogo.sdm.gui.RateConnection 3 405 110 455 110 505 111 NULL NULL 0 0 0
            org.jhotdraw.figures.ChopEllipseConnector REF 5
            org.jhotdraw.standard.ChopBoxConnector REF 3
            org.nlogo.sdm.gui.WrappedRate "tiempo" "fluj"
                org.nlogo.sdm.gui.WrappedReservoir  REF 4 0
        org.nlogo.sdm.gui.BindingConnection 2 356 191 455 110 NULL NULL 0 0 0
